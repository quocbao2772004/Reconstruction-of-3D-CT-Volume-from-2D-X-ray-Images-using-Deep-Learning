...
parser = ConfigParser()
parser.read(r"C:\Users\PC\pylidc.conf")

# Some constants
input_folder = r'D:\LIDC-IDRI-suitable'
output_folder = r'F:\project\AI-Medical-Image-Processing\Reconstruction-of-3D-CT-Volume-from-2D-X-ray-Images-using-Deep-Learning\aritra_project\dataset'
